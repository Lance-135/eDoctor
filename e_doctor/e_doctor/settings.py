"""
Django settings for e_doctor project.
...
SECRET_KEY = 'django-insecure-mcusf++d426==2q^bhq!o5=sfpz3p(v=5o!*&^75g)6gdu_m46'
...
# CSRF_COOKIE_SAMESITE = 'None'    # Required for CSRF
...
WSGI_APPLICATION = 'e_doctor.wsgi.application'
